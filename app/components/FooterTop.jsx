...
const FooterTop = () => {
  return (
    <div className="bg-[url(/assets/frame.png)] bg-cover bg-center bg-no-repeat relative">
      <div className="container mx-auto px-4 sm:px-6 pt-5 pb-8 sm:pt-[185px] sm:pb-[185px] flex justify-center items-center ">
        ...
        <div className="block sm:grid sm:grid-cols-2 z-10">
          <div className="">
            ...
            <button className="bg-primary text-white text-sm sm:text-lg pl-6 pr-2 py-2 rounded-lg font-semibold w-auto flex text-left items-center justify-between -skew-x-12 gap-5">
